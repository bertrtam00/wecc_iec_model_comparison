model T2
  ...
  Modelica.Blocks.Sources.Step xWTrefPu(height = 0.5, offset = 0, startTime = 1) annotation(
  ...
  Dynawo.Electrical.Lines.Line line_WECC(BPu = 0, GPu = 0, RPu = 0, XPu = 0.2) annotation(
