model test001_StepP
  ...
  Modelica.Blocks.Sources.Step pWTrefPu(height = 0.5, offset = 0.5, startTime = 5) annotation(
...
/* line.switchOffSignal1 is defined inside WECC model */
  connect(wT4ACurrentSource.terminal, line_IEC.terminal1) annotation(
    Line(points = {{-30.4, 28}, {-20, 28}}, color = {0, 0, 255}));
  connect(pWTrefPu.y, wT4ACurrentSource.PWTRefPu) annotation(
    Line(points = {{-121, 30}, {-81.15, 30}, {-81.15, 31}, {-66.4, 31}}, color = {0, 0, 127}));
  connect(xWTrefPu.y, wT4ACurrentSource.xWTRefPu) annotation(
    Line(points = {{-119, -8}, {-80.9, -8}, {-80.9, 25}, {-66.4, 25}}, color = {0, 0, 127}));
