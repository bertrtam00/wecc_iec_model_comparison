model test000
  ...
  Dynawo.Electrical.Lines.Line line_WECC(BPu = 0, GPu = 0, RPu = 0, XPu = 0.0001) annotation(
...
/* line.switchOffSignal1 is defined inside WECC model */
  ...
  connect(xWTrefPu.y, wT4ACurrentSource.xWTRefPu) annotation(
    Line(points = {{-99, 16}, {-80.9, 16}, {-80.9, 25}, {-66.4, 25}}, color = {0, 0, 127}));
  ...
  connect(WECC_WT4B.QRefPu, xWTrefPu.y) annotation(
    Line(points = {{-69, -27}, {-92, -27}, {-92, 16}, {-99, 16}}, color = {0, 0, 127}));
