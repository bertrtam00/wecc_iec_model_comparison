model T5_postfault
  ...
  Dynawo.Electrical.Buses.InfiniteBusWithVariations bus_IEC(U0Pu = 1.005, UEvtPu = 1.2, UPhase = 0, omega0Pu = 1, omegaEvtPu = 1, tOmegaEvtEnd = 100, tOmegaEvtStart = 100, tUEvtEnd = 1.45, tUEvtStart = 1.3) annotation(
    Placement(visible = true, transformation(origin = {42, 28}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Dynawo.Electrical.Buses.InfiniteBusWithVariations bus_WECC(U0Pu = 1.005, UEvtPu = 1.2, UPhase = 0, omega0Pu = 1, omegaEvtPu = 1, tOmegaEvtEnd = 100, tOmegaEvtStart = 100, tUEvtEnd = 1.45, tUEvtStart = 1.3) annotation(
