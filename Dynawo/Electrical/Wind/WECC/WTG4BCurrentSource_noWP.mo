...
model WTG4BCurrentSource_noWP "WECC Wind Turbine model with a current source as interface with the grid"
  ...
  Dynawo.Electrical.Controls.WECC.REGC_A regc_a(IqrMaxPu = 999, IqrMinPu = -999, RateFlag = false, Rrpwr = 20,tFilterGC = tFilterGC, tG = tG, UInj0Pu = UInj0Pu, Id0Pu = Id0Pu, Iq0Pu = Iq0Pu)  annotation(
