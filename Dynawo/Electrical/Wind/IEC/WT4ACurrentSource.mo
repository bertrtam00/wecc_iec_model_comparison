...
equation
  ...
  connect(measurements.QFiltPu, control4A.QWTCFiltPu) annotation(
    Line(points = {{-2, 92}, {-86, 92}, {-86, -58}, {-82, -58}}, color = {0, 0, 127}));
  annotation(
    preferredView = "diagram",
    __OpenModelica_simulationFlags(initialStepSize = "0.001", lv = "LOG_STATS", nls = "kinsol", s = "ida", nlsLS = "klu", maxIntegrationOrder = "2", maxStepSize = "10", emit_protected = "()"),
    Icon(coordinateSystem(initialScale = 0.1, grid = {1, 1}, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-1.5, -1}, extent = {{-66.5, 32}, {66.5, -32}}, textString = "IEC WT4A")}),
    Diagram);
