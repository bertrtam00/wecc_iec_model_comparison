...
partial model BasePControl4 "Base active power control module for type 4 wind turbines (IEC N°61400-27-1)"
  ...
  */
  ...
  Modelica.Blocks.Sources.Constant constant1(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-94, 82}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(constant1.y, product1.u2) annotation(
    Line(points = {{-82, 82}, {-2, 82}, {-2, 66}}, color = {0, 0, 127}));
  annotation(
    preferredView = "diagram",
    Icon(coordinateSystem(grid = {1, 1}, initialScale = 0.1, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, -100}, {100, 100}}), Text(origin = {-16, 31}, extent = {{-76, -18}, {92, 28}}, textString = "IEC WT 4"), Text(origin = {-11, -34}, extent = {{-77, -16}, {100, 30}}, textString = "PControl")}),
