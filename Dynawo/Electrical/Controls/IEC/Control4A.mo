...
model Control4A "Whole generator control module for type 4A wind turbines (IEC N°61400-27-1)"
  ...
  */
  ...
  parameter Types.PerUnit Kqv "Voltage scaling factor for FRT current in pu (base UNom, SNom)" annotation(
    Dialog(tab = "QControl"));
  parameter Real Ni = 0.9 "TODO is this correct? Ni*Ti is time constant of anti-windup compensation" annotation(
    Dialog(tab = "QControl"));
  ...
  Dynawo.Electrical.Controls.IEC.BaseControls.CurrentLimiter currentLimiter(IMaxDipPu = IMaxDipPu, IMaxPu = IMaxPu, IpMax0Pu = IpMax0Pu, IqMax0Pu = IqMax0Pu, IqMin0Pu = IqMin0Pu, Kpqu = Kpqu, MdfsLim = MdfsLim, Mqpri = Mqpri, P0Pu = P0Pu, Q0Pu = Q0Pu, SNom = SNom, TableIpMaxUwt11 = 0.7, TableIpMaxUwt12 = 1.1, TableIpMaxUwt21 = 0.8, TableIpMaxUwt22 = 1.1, TableIpMaxUwt31 = 0.9, TableIpMaxUwt32 = 1.1, TableIpMaxUwt41 = 1.1, TableIpMaxUwt42 = 1.1, TableIpMaxUwt51 = 1.2, TableIpMaxUwt52 = 1.1, TableIpMaxUwt61 = 1.3, TableIpMaxUwt62 = 1.1, TableIpMaxUwt71 = 1.4, TableIpMaxUwt72 = 1.1, TableIqMaxUwt11 = 0.7, TableIqMaxUwt12 = 1.1, TableIqMaxUwt21 = 0.8, TableIqMaxUwt22 = 1.1, TableIqMaxUwt31 = 0.9, TableIqMaxUwt32 = 1.1, TableIqMaxUwt41 = 1.1, TableIqMaxUwt42 = 1.1, TableIqMaxUwt51 = 1.2, TableIqMaxUwt52 = 1.1, TableIqMaxUwt61 = 1.3, TableIqMaxUwt62 = 1.1, TableIqMaxUwt71 = 1.4, TableIqMaxUwt72 = 1.1, TableIqMaxUwt81 = 1.5, TableIqMaxUwt82 = 1.1, U0Pu = U0Pu, UPhase0 = UPhase0, UpquMaxPu = UpquMaxPu) annotation(
    Placement(visible = true, transformation(origin = {100, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.Electrical.Controls.IEC.BaseControls.QControl qControl(DUdb1Pu = DUdb1Pu, DUdb2Pu = DUdb2Pu, IqH1Pu = IqH1Pu, IqMaxPu = IqMaxPu, IqMinPu = IqMinPu, IqPostPu = IqPostPu, Kiq = Kiq, Kiu = Kiu, Kpq = Kpq, Kpu = Kpu, Kpufrt = Kpufrt, Kqv = Kqv, MqG = MqG, Mqfrt = Mqfrt, Ni = Ni, P0Pu = P0Pu, Q0Pu = Q0Pu, QMax0Pu = QMax0Pu, QMin0Pu = QMin0Pu, RDropPu = RDropPu, SNom = SNom, U0Pu = U0Pu, UMaxPu = UMaxPu, UMinPu = UMinPu, URef0Pu = URef0Pu, UqDipPu = UqDipPu, UqRisePu = UqRisePu, XDropPu = XDropPu, XWT0Pu = XWT0Pu, tPost = tPost, tQord = tQord, tS = tS, tUss = tUss) annotation(
