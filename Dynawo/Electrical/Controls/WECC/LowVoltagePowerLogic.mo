...
model LowVoltagePowerLogic
  ...
  parameter Real zerox(start=0.0) "LVPL zero crossing in p. u.";
  parameter Real brkpt(start=1.0) "LVPL breakpoint in p. u.";
  parameter Real lvpl1(start=1.0) "LVPL gain breakpoint in p. u.";
  Real mlvpl;
